...
* Not all operators make sense for all types. Examples:
  * `+` for integer values 👍 - <!-- .element: class="fragment" -->obviously works
  * `/` for string values 🤔 - <!-- .element: class="fragment" -->makes no sense
  * `>` for Boolean values 🤔 - <!-- .element: class="fragment" -->also makes no sense
