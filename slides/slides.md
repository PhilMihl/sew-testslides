...
| [`float`, `double`](https://www.w3schools.com/java/java_data_types_numbers.asp) | Floating point numeric values (general guideline: Use `double` for mathematical calculations)
...
* <!-- .element: class="fragment" --> Not all operators make sense for all types. Examples:
  * <!-- .element: class="fragment" --> `+` for integer values 👍 -<!-- .element: class="fragment" --> obviously works
  * <!-- .element: class="fragment" --> `/` for string values 🤔 -<!-- .element: class="fragment" --> makes no sense
  * <!-- .element: class="fragment" --> `>` for Boolean values 🤔 -<!-- .element: class="fragment" --> also makes no sense
