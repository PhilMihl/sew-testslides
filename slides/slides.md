...
* Not all operators make sense for all types. Examples:<!-- .element: class="fragment" -->
  * `+` for integer values 👍 - obviously works<!-- .element: class="fragment" -->
  * `/` for string values 🤔 - makes no sense<!-- .element: class="fragment" -->
  * `>` for Boolean values 🤔 - also makes no sense<!-- .element: class="fragment" -->
